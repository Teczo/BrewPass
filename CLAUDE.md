...
- **O.2 — Routing no-vendor lifecycle (`fallbacks.md` §2.2, §2.5).** **§2.2 ✅ DONE** (behavior change confirmed under rule #11); **§2.5 still pending** (follow-up).
  ...
  - **§2.5 (pending):** a vendor going offline **after charge, before delivery** should attempt reassignment at the **snapshotted price** (platform absorbs the rate delta, rule #6), falling through to the existing auto-refund only if no reassignment is possible. Touches already-charged orders — build as a focused follow-up.
